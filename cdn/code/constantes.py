# constantes.py
"""
Module contenant les constantes et configurations globales pour l'application.

Ce module définit les variables globales et les configurations utilisées
par les autres modules de l'application, telles que les identifiants des nœuds,
les répertoires de fichiers, les intervalles de temps, etc.
"""
import os
import random
import threading
